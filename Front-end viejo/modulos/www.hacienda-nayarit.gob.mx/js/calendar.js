...
//========================================================================================================
	...
	this.wBGColor = '#333333';				// weeks: background color
	...
	this.borderColor = '#333333';			// border color
...
//--------------------------------------------------------------------------------------------------------
	...
	this.weekdays = ["Sa", "Do", "Lu", "Ma", "Mi", "Ju", "Vi"];

	// months: must start with January
	this.months = ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];

	// error messages
	this.error = ["El año debe ser 1 - 3999!", "El mes debe ser 1 - 12!"];
